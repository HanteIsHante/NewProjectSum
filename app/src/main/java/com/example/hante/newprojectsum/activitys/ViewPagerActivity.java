...
import com.example.hante.newprojectsum.adapter.GuideViewPagerAdapter;
...
public class ViewPagerActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < pics.length; i++) {
            ...
            if (i == pics.length - 1) {
                startButton = (Button) view.findViewById(R.id.btn_enter);
    ...
    protected void onPause() {
        ...
        SharedPreferenceUtil.putBoolean(ViewPagerActivity.this, SharedPreferenceUtil.First_Open, false);
        finish();
    }
    ...
    private void enterMainActivity() {
        Intent intent = new Intent(ViewPagerActivity.this,
                NewProjectSumHomeActivity.class);
