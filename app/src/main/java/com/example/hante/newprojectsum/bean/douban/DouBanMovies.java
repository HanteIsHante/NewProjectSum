package com.example.hante.newprojectsum.bean.douban;
...
public class DouBanMovies implements Serializable {
    ...
    public List<SubjectsBean> getMSubjects () {
        return mSubjects;
    }

    public void setMSubjects (List<SubjectsBean> mSubjects) {
    ...
    public static class SubjectsBean {
        ...
        public RatingBean getMRating () {
            return mRating;
        }

        public void setMRating (RatingBean mRating) {
        ...
        public int getMTollect_count () {
            return mTollect_count;
        }

        public void setMTollect_count (int mTollect_count) {
            this.mTollect_count = mTollect_count;
        }
        ...
        public ImagesBean getMImages () {
            return mImages;
        }

        public void setMImages (ImagesBean mImages) {
        ...
        public List<CastsBean> getMCasts () {
            return mCasts;
        }

        public void setMCasts (List<CastsBean> mCasts) {
            this.mCasts = mCasts;
        }

        public List<DirectorsBean> getMDirectors () {
            return mDirectors;
        }

        public void setMDirectors (List<DirectorsBean> mDirectors) {
        ...
        public static class RatingBean {
            ...
            public void setMStars (String mStars) {
                this.mStars = mStars;
            }
        ...
        public static class ImagesBean {
            ...
            public String getMIarge () {
                return mIarge;
            }

            public void setMIarge (String mIarge) {
                this.mIarge = mIarge;
            }
        ...
        public static class CastsBean {
            ...
            public AvatarsBean getMAvatars () {
                return mAvatars;
            }

            public void setMAvatars (AvatarsBean mAvatars) {
